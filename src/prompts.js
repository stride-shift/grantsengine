...
// NOTE: CTX/CTX_SLIM are no longer needed here — scoutPrompt doesn't use them.
// App.jsx imports CTX/CTX_SLIM directly for its inline prompts.

// ── SCOUT ──
export const scoutPrompt = ({ existingFunders, market = "both" }) => {
  ...
  const searchScope = market === "sa"
    ? "Search for open grants in South Africa for youth digital skills NPOs, March 2026. Focus on SETA windows, corporate CSI open calls, SA foundation rounds, and government funding."
    : market === "global"
    ? "Search for international and global grant opportunities for a South African youth digital skills NPO, March 2026. Focus on global foundations, development agencies, international tech companies, and multilateral funders that fund African NGOs."
    : "Search for open grants for a South African youth digital skills NPO, March 2026. Include both SA domestic funders (SETAs, corporate CSI, foundations) AND international funders (global foundations, tech companies, development agencies).";
...
Return 8-12 real, current opportunities.`,
    user: `${searchScope} d-lab already has applications with: ${existingFunders}. Find NEW opportunities not already in the pipeline. For each one, VERIFY whether they accept unsolicited applications — check their website for open calls, portals, or application guidelines.`,
    maxTok: 3000,
    search: true,
  };
};
