...
import useHygiene from "./hooks/useHygiene";
...
function AppInner() {
  ...
  // Background hygiene job — extracted to its own hook (see useHygiene.js).
  // Called here, after dSave is defined, because it closes over dSave.
  useHygiene({ grants, runAI, currentMember, setGrants, dSave, toast });
