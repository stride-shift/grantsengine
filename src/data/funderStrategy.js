...
export const PTYPES = {
  ...
  7: { label: "Sci-Bono Employability Skills", students: 90, cost: 231790, perStudent: 2576, duration: "13 weeks (15 days)", desc: "Short-format: 7 AI coaching days + Design Thinking (1-day + 5-day sprints + 2 presentation days). Includes Cyborg Habits platform.", budget: "AI coaching R84K (2 coaches × R1K/hr × 6hrs × 7d) + DT coaching R64K (1 coach × R2K/hr × 4hrs × 8d) + Cyborg Habits R84K (R930 × 90)", table: [["AI coaching (2 coaches × 7 days)","84,000"],["DT coaching (1 coach × 8 days)","64,000"],["Cyborg Habits platform (90 × R930)","83,790"],["TOTAL","231,790"]] },
};
