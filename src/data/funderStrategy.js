...
export const funderStrategy = g => {
  ...
  const angles = {
    ...
    "Inkcubeko": { lead: "deepening the partner delivery model in the Western Cape", hook: "Inkcubeko has been d-lab's Western Cape delivery partner since 2024, providing the venue, student recruitment, and local infrastructure while d-lab provides curriculum, coaching, AI tools, and accreditation. The R1.23M service fee for 2026 covers a full Type 3 cohort (20 students with stipends) in George — the same model that delivered 92% completion in 2025.", sections: ["Partnership Model", "2025 Delivery Report", "2026 Cohort Plan", "Budget", "Student Outcomes"], lang: "partnership, delivery, community, Western Cape, model", returning: true },
    ...
    "Sci-Bono Discovery Centre": { lead: "cost-effective employability skills for school-leavers", hook: "Sci-Bono's mission to inspire young people in STEM extends naturally into employability. d-lab's 13-week programme — at just R2,576 per learner — turns 90 school-leavers into AI-literate, Design Thinking-capable candidates ready for the workplace.", sections: ["Cost Effectiveness", "STEM Extension", "Practical Skills", "Scale"], lang: "STEM, discovery, practical skills, cost-effective" },
    "The Field Institute / CCBA": { lead: "leadership development for graduate professionals", hook: "CCBA's Graduate Leadership Accelerator — an 18-month programme for 25 graduates across African markets — launched in February 2026 and is now delivering. Combined with the 2024 Future Leaders sprints, d-lab has a proven track record of building stronger leaders through Design Thinking, AI tools, and structured coaching.", sections: ["Programme Evolution", "Leadership Outcomes", "Delivery Model", "Corporate Track Record"], lang: "leadership, graduate development, coaching, self-awareness, bespoke" },
    ...
    "SAB Foundation": { lead: "social innovation that creates youth employment pathways", hook: "SAB Foundation backs social innovators who create real economic participation for marginalised South Africans. d-lab's AI-native training model — where 85% of graduates are employed within 3 months — is exactly the kind of scalable social innovation that transforms unemployment into opportunity.", sections: ["Social Innovation", "Employability Pipeline", "Inclusive Design", "Scale & Sustainability"], lang: "social innovation, entrepreneurship, inclusion, disability, marginalised, economic participation, scalable" },
    "Kagiso Trust": { lead: "quality education and skills development in underserved communities", hook: "Kagiso Trust's long-standing commitment to quality education for disadvantaged communities aligns with d-lab's partner delivery model — bringing ICITP-accredited, AI-powered skills training to young people who have talent but no pathway. Our 92% completion rate proves that world-class training can work in under-resourced settings.", sections: ["Education Quality", "Community Impact", "Accreditation", "Evidence"], lang: "education, community development, quality, access, transformation" },
    "Aspire Coronation Trust Foundation": { lead: "education and skills for economic empowerment", hook: "The ACT Foundation's focus on education and skills development as a lever for economic empowerment makes d-lab a natural fit — our model takes unemployed youth from zero digital skills to employed, AI-fluent professionals in 9 months, with 85% employment outcomes.", sections: ["Education", "Economic Empowerment", "Evidence of Impact", "Sustainability"], lang: "education, empowerment, skills, measurable impact, sustainable" },
    "ACT Foundation": { lead: "education and skills for economic empowerment", hook: "The ACT Foundation's focus on education and skills development as a lever for economic empowerment makes d-lab a natural fit — our model takes unemployed youth from zero digital skills to employed, AI-fluent professionals in 9 months, with 85% employment outcomes.", sections: ["Education", "Economic Empowerment", "Evidence of Impact", "Sustainability"], lang: "education, empowerment, skills, measurable impact, sustainable" },
    "British International Investment": { lead: "digital skills and economic development in Africa", hook: "BII's mandate to drive productive, sustainable, and inclusive development across Africa aligns with d-lab's scalable partner model — proven in 3 provinces, AI-powered, and producing 85% employment outcomes at R25,800 per student. d-lab represents exactly the kind of investable social infrastructure that builds digital capability at scale.", sections: ["Development Impact", "Digital Economy", "Scale Model", "Sustainability"], lang: "development finance, digital, inclusive growth, scalable, Africa" },
    "Harambee": { lead: "bridging the gap between youth talent and employer demand", hook: "Harambee's mission to connect young people to employment aligns directly with d-lab's outcomes — 85% employment within 3 months, 29% placed before graduation. Together, d-lab's training system and Harambee's employer network could create a powerful pipeline from skills to work.", sections: ["Employment Pipeline", "Partnership Model", "Scale", "Youth Outcomes"], lang: "youth employment, pathway, employer, scale, work-readiness" },
    "iQ": { lead: "white-label AI and digital skills programme under iQ's brand", hook: "iQ can offer clients a turnkey AI and digital skills programme — powered by d-lab's proven curriculum (92% completion, 85% employment) and proprietary AI tools — delivered under iQ's brand. No curriculum development needed, no delivery risk: d-lab provides the system, iQ owns the client relationship.", sections: ["Partnership Proposition", "White-Label Model", "Curriculum & Tools", "Commercial Terms"], lang: "white-label, partnership, AI skills, turnkey, brand, delivery" },
    "Chartall": { lead: "white-label AI and digital skills programme under Chartall's brand", hook: "Chartall can differentiate its offering with a white-label digital skills programme powered by d-lab's AI-native curriculum. Proven outcomes (92% completion, 85% employment), proprietary AI tools, and a delivery system Chartall can brand as its own — no development cost, no delivery risk.", sections: ["Partnership Proposition", "White-Label Model", "Curriculum & Tools", "Commercial Terms"], lang: "white-label, partnership, AI skills, turnkey, brand, delivery" },
    "FirstRand Foundation": { lead: "innovative approaches to youth employment", hook: "FirstRand Foundation funds bold ideas that can change the trajectory of young South Africans' lives. d-lab's AI-native model — where completion rates are nearly double the sector average — represents a genuinely new approach to an old problem.", sections: ["Innovation", "Scalability", "Evidence", "Sustainability"], lang: "innovation, bold, scalable, evidence-based" },
    "Tshikululu Social Investments": { lead: "systems-level youth employability with measurable outcomes", hook: "Tshikululu's mandate to maximise social investment impact through systemic, evidence-based programmes aligns precisely with d-lab's model. We don't just train young people — we've built a replicable system that converts R25,800 per student into 85% employment outcomes across three provinces, with ICITP accreditation, AI-enabled assessment, and employer-validated competence. Tshikululu's emphasis on moving from funding programmes to funding systems matches d-lab's evolution from pilot to proven delivery architecture.", sections: ["Systems-Level Impact", "Evidence & Outcomes", "Cost Effectiveness", "Institutional Capacity", "Accreditation & Quality Assurance", "Sustainability & Scale"], lang: "systemic change, social investment, evidence-based, cost-effective, institutional strengthening, youth employment, accredited, scalable, transformation, capacity building" },
    "Tshikululu": { lead: "systems-level youth employability with measurable outcomes", hook: "Tshikululu's mandate to maximise social investment impact through systemic, evidence-based programmes aligns precisely with d-lab's model. We don't just train young people — we've built a replicable system that converts R25,800 per student into 85% employment outcomes across three provinces, with ICITP accreditation, AI-enabled assessment, and employer-validated competence. Tshikululu's emphasis on moving from funding programmes to funding systems matches d-lab's evolution from pilot to proven delivery architecture.", sections: ["Systems-Level Impact", "Evidence & Outcomes", "Cost Effectiveness", "Institutional Capacity", "Accreditation & Quality Assurance", "Sustainability & Scale"], lang: "systemic change, social investment, evidence-based, cost-effective, institutional strengthening, youth employment, accredited, scalable, transformation, capacity building" },
  };
