...
// Canonical org context for AI prompts — single source of truth in src/data/context.js
import { CTX as CTX_FULL, CTX_SLIM } from '../src/data/context.js';
...
updateOrgProfile(orgId, {
  ...
  programmes: [
    ...
    { id: 'type8', name: 'Bespoke Corporate — Leadership Accelerator', cost: 2753418, desc: '25 graduate hires, 18 months, delivered via The Field Institute' },
  ],
  impact_stats: {
...
const team = [
  ...
  { id: 'shanne', name: 'Shanne', initials: 'SS', role: 'pm', persona: 'Social media, communications, and community engagement.' },
...
const SEED = [
  ...
  { id: "g8", name: "Google.org Impact Challenge", funder: "Google.org", type: "Tech Company", stage: "scouted", ask: 2997000, deadline: null, focus: ["AI/4IR", "Education", "EdTech"], geo: [], rel: "Cold", pri: 4, hrs: 0, notes: "1 x Type 2 d-lab funded cohort + AI platform R&D.", log: [], on: "", of: [], owner: "team", docs: {}, fups: [], subDate: null, applyUrl: "https://www.google.org/opportunities/", market: "global" },
  { id: "g9", name: "Mastercard Foundation", funder: "Mastercard Foundation", type: "International", stage: "scouted", ask: 5173000, deadline: null, focus: ["Youth Employment", "Digital Skills"], geo: [], rel: "Cold", pri: 3, hrs: 0, notes: "Young Africa Works — Year 1 proof proposal.", log: [], on: "", of: [], owner: "team", docs: {}, fups: [], subDate: null, applyUrl: "https://mastercardfdn.org/young-africa-works/", market: "global" },
