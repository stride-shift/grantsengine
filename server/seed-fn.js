...
export async function runSeed() {
  ...
  await updateOrgProfile(orgId, {
    ...
    programmes: [
      ...
      { id: 'type6', name: 'Cyborg Habits Short Course', cost: 570, desc: 'AI literacy short course, per-licence pricing' },
      { id: 'type7', name: 'Intensive Short Format', cost: 199300, desc: '15 days over 13 weeks, 90 school-leavers' },
    ],
    impact_stats: {
